...
if (
    ...
    # Header
    $title = "LearnTech.AI - Create Course ";
...
?>
    <div class="container">
        ...
        <div class="mt-5" style="max-width: 800px;">
            ...
            <hr><form id="Topic" class="mt-5" action="Action/course-topic-add.php" method="POST">
    ...
    <!-- Chapter Selection (Initially Empty, Loaded via AJAX) -->
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="topicTitle" placeholder="Enter topic title" name="topic_title" required>
    </div>
...
<script>
    document.getElementById("courseSelectTopic").addEventListener("change", function () {
        ...
        if (courseId) {
            fetch(`fetch_chapters.php?course_id=${courseId}`)
