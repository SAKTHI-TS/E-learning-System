...
<div class="container">
<button class="btn btn-primary mt-3" onclick="window.location.href='index1.html';">Check the  latest  Article</button>
<button class="btn btn-primary mt-3" onclick="window.location.href='http://192.168.238.103:3000/';">Test on me</button>
